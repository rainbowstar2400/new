...
| P0-17 | Test | 単体/結合/主要E2E | 主要UCの自動検証 | P0-01〜P0-16 | PRD 9章受け入れを満たす |
...
| ID | 種別 | タイトル | 主な内容 | 依存 | 受け入れ条件 |
| --- | --- | --- | --- | --- | --- |
| P1-01 | Reminder | 時刻未指定リマインド改善 | UC-05/09系の補足確認と提案改善 | P0-13 | UC-05, UC-09 の成功率改善 |
| P1-02 | Logic | 相対日付解釈精度強化 | 来週/翌週/再来週など境界ケース補強 | P0-11 | UC-09 安定通過 |
| P1-03 | UX | 確認UIの操作性改善 | `○/✕` 導線の視認性・誤操作低減 | P0-09, P0-14 | 誤操作率の低下 |
