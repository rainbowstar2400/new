import type { ChatMessageResponse, ConfirmationType, InputMode } from "@new/shared";
...
function inferConfirmationTypeLegacy(response: ChatMessageResponse): ConfirmationType | null {
...
export function inferChatControl(response: ChatMessageResponse): ChatControlState {
...
export function isTextInputAllowed(control: ChatControlState): boolean {
  return control.inputMode === "free_text";
}

export function chatControlHint(control: ChatControlState): string | null {
